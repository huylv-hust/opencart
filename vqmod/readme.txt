...
B1: Coppy folder vqmod vào trong folder upload
B2: Chọn mở folder vqmod bằng quyền admin (allow tất cả)
B3: Nhập đường link localhost/opencart/upload/vqmod/install/
done